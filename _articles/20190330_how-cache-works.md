...
![페이지 참조 기록. 수평축 실행 시간. 수직축 메모리 주소.](images/54877425-e73f7280-4e61-11e9-9526-d33a04c189f3.png)
...
![인덱스를 통해 데이터에 접근하는 과정.](images/54876163-83f81500-4e4e-11e9-9ff7-605149fc4e1c.png)
...
![인덱스와 태그를 통해 테이터에 접근하는 과정.](images/54875998-d71c9880-4e4b-11e9-80b6-ecf955e971e3.png)
...
![2-way set associative 캐시 동작 과정.](images/54878224-042d7300-4e6d-11e9-9036-8646a8bb935a.png)
...
![0001을 참조.](images/54880531-cd655600-4e88-11e9-86b6-0904fcb6c0a5.png)
...
![0001과 0010을 캐시.](images/54880533-cdfdec80-4e88-11e9-8893-e21456590d04.png)
...
![0101을 참조.](images/54880534-cdfdec80-4e88-11e9-88cb-ba3ea41b97a7.png)

메모리 주소 `0101`을 참조하는 명령이 실행되었다. 이번에도 인덱스가 `0`인 두 공간에 들어갈 수 있다. 

![0101과 0110을 캐시.](images/54880535-ce968300-4e88-11e9-80da-1ea0ea49f557.png)
...
![1000을 참조. 미스 발생.](images/54880532-cdfdec80-4e88-11e9-8d6b-7c54aeb6c5d1.png)

이어서 메모리 주소 `1000`을 참조하는 명령이 실행되었다. 인덱스가 `0`인 두 블록을 확인했으나, 태그가 `10`인 데이터가 없어 캐스 미스가 발생했다.

![0111과 1000을 캐시.](images/54880536-cf2f1980-4e88-11e9-80c2-e84f77d9ecee.png)
...
![캐싱한 데이터에 다시 접근하기 전에 캐시 블록을 교체.](images/54995939-5d330d80-500b-11e9-9f68-8e8a55ced91a.png)
...
![캐싱한 데이터에 연속적으로 접근.](images/54995941-5efcd100-500b-11e9-90fe-f45048ba7641.png)
