...
[oh-my-zsh 저장소에서 기본 테마를 살펴볼 수 있다.](https://github.com/robbyrussell/oh-my-zsh/wiki/Themes) 사용하고자 하는 테마가 기본 테마가 아니라면 테마를 설치하고, oh-my-zsh의 themes 디렉토리에 테마 파일을 넣어줘야 한다. [powerlevel10k](https://github.com/romkatv/powerlevel10k) 테마를 사용하면 쉽게 시각 요소를 설정할 수 있다.

```sh
$ git clone --depth=1 https://github.com/romkatv/powerlevel10k.git $ZSH_CUSTOM/themes/powerlevel10k
```

powerlevel10k 테마 설치 후 `p10k` 명령을 이용해 테마 설정을 시작하면 된다. 설정 과정이 워낙 직관적이라서 별다른 설명이 필요하지 않다.
