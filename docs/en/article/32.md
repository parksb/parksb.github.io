...
![A yak.](/images/60662976-d78bed00-9e98-11e9-9832-908c731a6989.jpg)
...
<!-- TRANSLATION NOTES
- Korean-language citations (footnotes 25, 5, 7) keep their original titles/authors, since
  they point to Korean-language sources. Footnote 25 cites the specific Korean edition of
  The Mythical Man-Month (with its page numbers), so it's left in Korean even though the
  body uses the English title.
- "The Elements of Computing Systems" is the English title of the book the source cites by
  its Korean title (밑바닥부터 만드는 컴퓨팅 시스템); the link still points to the Korean
  publisher's page, as in the original.
- Seth Godin's list: the source paraphrases his example as "wash the car" (Godin's original
  says "wax"). Translated as the author wrote it (wash).
-->
